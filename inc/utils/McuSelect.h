...
#define HF_MCU_GPIO_PIN_COUNT 40            ///< Total GPIO pins (GPIO0-GPIO39)
#define HF_MCU_GPIO_MAX_PIN_NUMBER 39       ///< Maximum valid GPIO pin number
#define HF_MCU_GPIO_RTC_PIN_COUNT 18        ///< RTC GPIO pins
#define HF_MCU_GPIO_LP_IO_PIN_COUNT 0       ///< No LP_IO on classic ESP32
#define HF_MCU_GPIO_ADC_PIN_COUNT 18        ///< ADC capable pins (ADC1: 8, ADC2: 10)
#define HF_MCU_GPIO_FLEX_FILTER_COUNT 0     ///< No flex glitch filter on classic ESP32
#define HF_MCU_GPIO_TOUCH_PIN_COUNT 10      ///< Touch capable pins
#define HF_MCU_GPIO_DAC_PIN_COUNT 2         ///< DAC pins (GPIO25, GPIO26)
#define HF_MCU_GPIO_ETM_CHANNEL_COUNT 0     ///< No ETM on classic ESP32
...
#define HF_MCU_TASK_STACK_SIZE 4096  // Xtensa
#else
#define HF_MCU_TASK_STACK_SIZE 3072  // RISC-V
#endif
#define HF_MCU_TASK_PRIORITY 5
