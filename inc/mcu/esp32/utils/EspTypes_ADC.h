...
struct hf_adc_continuous_config_t {
  ...
  uint32_t
      samples_per_frame; ///< Number of samples per frame per enabled channel (64-1024 recommended)
...
constexpr uint32_t HF_ESP32_ADC_DATA_BYTES_PER_CONV =
    SOC_ADC_DIGI_DATA_BYTES_PER_CONV;                  ///< Bytes per conversion result from ESP-IDF
