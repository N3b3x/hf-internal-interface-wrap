...
// Number of LEDC channels depends on the MCU variant. For ESP32, there are 6.
...
static constexpr uint32_t HF_PWM_MIN_FREQUENCY =
    100; // ESP32 LEDC practical minimum with 10-bit resolution
static constexpr uint32_t HF_PWM_MAX_FREQUENCY = 20000000; // ESP32 LEDC practical maximum
