...
/**
 * @brief I2C handle types for ESP-IDF v5.5+ bus-device API.
 */
#ifdef HF_MCU_FAMILY_ESP32
using hf_i2c_master_bus_handle_t = i2c_master_bus_handle_t;
using hf_i2c_device_handle_t = i2c_master_dev_handle_t;
using hf_i2c_cmd_handle_t = i2c_cmd_handle_t;
#else
using hf_i2c_master_bus_handle_t = void *;
using hf_i2c_device_handle_t = void *;
using hf_i2c_cmd_handle_t = void *;
#endif
 ...
 * @details GPIO10-11 not available on SiP flash variants, GPIO14 not available on non-flash
 * variants.
 */
static constexpr uint8_t HF_GPIO_UNAVAILABLE_SIP_PINS[] = {
    10, 11}; ///< Not available on SiP flash variants
static constexpr uint8_t HF_GPIO_UNAVAILABLE_NOFLASH_PINS[] = {
    14}; ///< Not available on non-flash variants
...
static constexpr uint32_t HF_GPIO_GLITCH_FILTER_MIN_NS =
    50; ///< Minimum filter window (nanoseconds)
static constexpr uint32_t HF_GPIO_GLITCH_FILTER_MAX_NS =
    1000000; ///< Maximum filter window (nanoseconds)
