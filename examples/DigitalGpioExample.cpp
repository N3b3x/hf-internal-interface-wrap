...
void ExampleMcuGpioDynamicMode() {
  ...
  McuDigitalGpio gpio_pin(GPIO_NUM_2, DigitalGpio::Direction::Input, DigitalGpio::ActiveState::High,
                          DigitalGpio::OutputMode::PushPull, DigitalGpio::PullMode::PullUp);
...
void ExamplePcal95555GpioDynamicMode() {
  ...
  auto expander_pin =
      CreatePcal95555Pin(0, // Pin 0 on PCAL95555
                         pcal95555_driver, 0x20, DigitalGpio::Direction::Output,
                         DigitalGpio::ActiveState::Low, // Active-low LED
                         DigitalGpio::OutputMode::PushPull, DigitalGpio::PullMode::Floating);
...
void ExampleMixedGpioUsage() {
  ...
  // Add MCU pins
  gpio_pins.emplace_back(
      std::make_unique<McuDigitalGpio>(GPIO_NUM_2, DigitalGpio::Direction::Output));
  gpio_pins.emplace_back(std::make_unique<McuDigitalGpio>(
      GPIO_NUM_4, DigitalGpio::Direction::Input, DigitalGpio::ActiveState::High,
      DigitalGpio::OutputMode::PushPull, DigitalGpio::PullMode::PullUp));
  ...
  for (auto &pin : gpio_pins) {
    ...
    DigitalGpio::Direction new_direction =
        pin->IsInput() ? DigitalGpio::Direction::Output : DigitalGpio::Direction::Input;
