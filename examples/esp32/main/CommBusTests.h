...
enum class CommBusTestType {
  ...
  I2C_REGISTER_OPERATIONS_TEST,
  I2C_DEVICE_SCAN_TEST,
...
private:
  ...
  bool TestI2cDeviceScan();
  bool TestI2cErrorHandling();
  ...
  bool TestUartFlowControl();
  bool TestUartErrorHandling();
...
public:
  ...
  bool RespondToScan() const {
    return respondToScan_;
  }
  void SetRespondToScan(bool respond) {
    respondToScan_ = respond;
  }
