...
void BasicDigitalOutputGuardExample() {
    ...
    std::cout << "Initial GPIO direction: " << DigitalGpio::ToString(gpio.GetDirection()) << std::endl;
    ...
    
    {
        ...
        if (guard.IsValid()) {
            ...
            std::cout << "GPIO direction after guard creation: " << DigitalGpio::ToString(gpio.GetDirection()) << std::endl;
            std::cout << "GPIO state after guard creation: " << DigitalGpio::ToString(gpio.GetCurrentState()) << std::endl;
            ...
            std::cout << "GPIO state after manual SetInactive: " << DigitalGpio::ToString(gpio.GetCurrentState()) << std::endl;
            ...
            std::cout << "GPIO state after manual SetActive: " << DigitalGpio::ToString(gpio.GetCurrentState()) << std::endl;
        } else {
            std::cout << "Guard creation failed with error: " << HfGpioErrToString(guard.GetLastError()) << std::endl;
        }
    ...
    std::cout << "GPIO state after guard destruction: " << DigitalGpio::ToString(gpio.GetCurrentState()) << std::endl;
    std::cout << "GPIO direction after guard destruction: " << DigitalGpio::ToString(gpio.GetDirection()) << std::endl;
    std::cout << std::endl;
}
...
void ErrorHandlingExample() {
    ...
    if (!guard.IsValid()) {
        std::cout << "Guard correctly rejected null pointer with error: " << HfGpioErrToString(guard.GetLastError()) << std::endl;
    }
...
void ActiveLowExample() {
    ...
    std::cout << "Initial GPIO polarity: " << DigitalGpio::ToString(gpio.GetActiveState()) << std::endl;
    std::cout << "Initial GPIO direction: " << DigitalGpio::ToString(gpio.GetDirection()) << std::endl;
