 ...
 * @brief Platform-agnostic periodic timer wrapper.
 *
 * This class creates a platform-specific timer that repeatedly invokes a user provided
...
public:
   ...
   */
  PeriodicTimer(Callback cb, void *arg) noexcept;
