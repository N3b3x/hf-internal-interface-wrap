...
#ifndef MCU_SPI_BUS_H
#define MCU_SPI_BUS_H

#include "BaseSpiBus.h"
#include "McuTypes.h"
#include <mutex>
 ...
 * platform-specific details while providing the unified BaseSpiBus API.
 *
 * Features:
 ...
 */
class McuSpiBus : public BaseSpiBus {
public:
    /**
     * @brief Constructor with configuration.
     * @param config SPI bus configuration parameters
     */
    explicit McuSpiBus(const SpiBusConfig& config) noexcept;

    /**
     * @brief Destructor - ensures proper cleanup.
     */
    ~McuSpiBus() noexcept override;
