...
#ifndef MCU_UART_DRIVER_H
#define MCU_UART_DRIVER_H

#include "BaseUartDriver.h"
#include "McuTypes.h"
#include <mutex>
#include <cstdarg>
 ...
 * platform-specific details while providing the unified BaseUartDriver API.
 *
 * Features:
 ...
 */
class McuUartDriver : public BaseUartDriver {
public:
    /**
     ...
     */
    McuUartDriver(hf_uart_port_t port, const UartConfig& config) noexcept;

    /**
     * @brief Destructor - ensures proper cleanup.
     */
    ~McuUartDriver() noexcept override;
