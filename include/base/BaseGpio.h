...
public:
   ...
   * @param pin_num Platform-specific GPIO pin identifier
   ...
   */
  explicit BaseGpio(hf_gpio_num_t pin_num, 
   ...
   * @return Platform-specific pin identifier
   */
  [[nodiscard]] hf_gpio_num_t GetPin() const noexcept {
    return pin_;
  }
...
protected:
  ...
  const hf_gpio_num_t pin_;           ///< GPIO pin number/identifier
